...
def combine_data(select_statement,data):
    statements_and_params.append((select_statement,(str(data['App']),str(data['Category']),str(data['Rating']),str(data['Reviews']),str(data['Size']),str(data['Installs']),str(data['Type']),str(data['Price']),str(data['Content Rating']),str(data['Genres']),str(data['Last Updated']),str(data['Current Ver']),str(data['Android Ver']))))
